        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
            ...
            if(!isset($_SESSION['email']) || empty($_SESSION['email']))
            	{}else{
            ?>
            <li><a href="myorderpage.php">ORDER</a></li>
  ...
  <div class="text-center">
    ...
    <div class="row slideanim">
      <form method="POST" action="neworder.php">
            ...
            <label style="width:15%;">Source:</label>
            <select name="source" id="source" style="border-radius:10%; width: 20%; border-radius: 4px; border: 1px solid #DADADA; font-size: 14px; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; height: 32px;">
            ...
            <label style="width:15%;">Destination:</label>
            <select name="destination" id="destination" style="border-radius:10%; width: 20%; border-radius: 4px; border: 1px solid #DADADA; font-size: 14px; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; height: 32px;">
                <option >Asia</option>
            ...
            <select name="cargo_type" id="cargo_type" style="border-radius:10%; width: 20%; border-radius: 4px; border: 1px solid #DADADA; font-size: 14px; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; height: 32px;">
