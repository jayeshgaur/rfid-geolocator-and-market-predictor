...
const char *ssid = "Xiaomi_BAAF"; 
const char *password = "Jayeshwifi";
...
void sendRfidLog(long cardId) {
  ...
  //http.begin("http://192.168.56.1/rfid/log.php");
   http.begin("http://192.168.31.14/Cargo_final/Webpages/rfid/adminRfidInsert.php");            
